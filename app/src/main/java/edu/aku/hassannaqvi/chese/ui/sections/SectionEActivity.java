...
import edu.aku.hassannaqvi.chese.databinding.ActivitySectionEBinding;
...
public class SectionEActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = db.updatesFormColumn(Forms.FormsTable.COLUMN_SE, form.sEtoString());
        if (updcount == 1) {
            return true;
        } else {
    ...
    public void takePhoto(View view) {
        ...
        intent.putExtra("imgName", getResources().getString(R.string.f5image) + "_" + photoCount);
        intent.putExtra("picView", getResources().getString(R.string.f5title));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            ...
            if (requestCode == 1 && resultCode == 1) {
                ...
                bi.txtf5image.setText(fileName + " - " + photoCount);
