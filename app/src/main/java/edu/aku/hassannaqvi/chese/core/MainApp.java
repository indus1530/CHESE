...
import static edu.aku.hassannaqvi.chese.database.DatabaseHelper.DATABASE_NAME;
import static edu.aku.hassannaqvi.chese.database.DatabaseHelper.DATABASE_PASSWORD;
