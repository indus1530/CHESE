...
import edu.aku.hassannaqvi.chese.databinding.ActivitySectionDBinding;
...
public class SectionDActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = db.updatesFormColumn(Forms.FormsTable.COLUMN_SD, form.sDtoString());
        if (updcount == 1) {
            return true;
        } else {
    ...
    public void takePhoto(View view) {
        ...
        intent.putExtra("imgName", getResources().getString(R.string.f4image) + "_" + photoCount);
        intent.putExtra("picView", getResources().getString(R.string.f4title));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            ...
            if (requestCode == 1 && resultCode == 1) {
                ...
                bi.txtf4image.setText(fileName + " - " + photoCount);
