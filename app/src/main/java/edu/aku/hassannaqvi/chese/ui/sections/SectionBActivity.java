...
import edu.aku.hassannaqvi.chese.databinding.ActivitySectionBBinding;
...
public class SectionBActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = db.updatesFormColumn(Forms.FormsTable.COLUMN_SV3, form.sV3toString());
        if (updcount == 1) {
            return true;
        } else {
    ...
    public void takePhoto(View view) {
        ...
        intent.putExtra("imgName", getResources().getString(R.string.f2image) + "_" + photoCount);
        intent.putExtra("picView", getResources().getString(R.string.f2title));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            ...
            if (requestCode == 1 && resultCode == 1) {
                ...
                bi.txtf2image.setText(fileName + " - " + photoCount);
