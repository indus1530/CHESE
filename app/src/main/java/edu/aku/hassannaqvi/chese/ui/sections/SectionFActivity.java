...
import edu.aku.hassannaqvi.chese.databinding.ActivitySectionFBinding;
...
public class SectionFActivity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = db.updatesFormColumn(Forms.FormsTable.COLUMN_SF, form.sFtoString());
        if (updcount == 1) {
            return true;
        } else {
    ...
    public void takePhoto(View view) {
        ...
        intent.putExtra("imgName", getResources().getString(R.string.f6image) + "_" + photoCount);
        intent.putExtra("picView", getResources().getString(R.string.f6title));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            ...
            if (requestCode == 1 && resultCode == 1) {
                ...
                bi.txtf6image.setText(fileName + " - " + photoCount);
